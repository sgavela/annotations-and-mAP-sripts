...
def convert_annotation(output, data, data_type = "val"):
    ...
    replace_dict = {"couch": "sofa", "airplane": "aeroplane", "tv": "tvmonitor", "motorcycle": "motorbike", "street-light": "traffic light"}
    #replace_dict = {"person": "pedestrian", "motor": "motorcycle", "bike": "bicycle"}
    #replace_dict = {"nombre en tu dataset": "nombre en coco.names"}
